...
public class OrderItemAsserts {
    ...
    public static void assertOrderItemUpdatableFieldsEquals(OrderItem expected, OrderItem actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getSizeType()).as("check sizeType").isEqualTo(expected.getSizeType()))
            .satisfies(a -> assertThat(a.getCustomLength()).as("check customLength").isEqualTo(expected.getCustomLength()))
            .satisfies(a -> assertThat(a.getCustomWidth()).as("check customWidth").isEqualTo(expected.getCustomWidth()))
    ...
    public static void assertOrderItemUpdatableRelationshipsEquals(OrderItem expected, OrderItem actual) {
        assertThat(actual)
            ...
            .satisfies(a -> assertThat(a.getDefaultSize()).as("check defaultSize").isEqualTo(expected.getDefaultSize()))
