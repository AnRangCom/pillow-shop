...
import static com.exe201.pillow.domain.CustomerAsserts.*;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "0I@L.R";
    private static final String UPDATED_EMAIL = "|9FNlc@{:\\t:Y.YOo~";
