...
import static com.exe201.pillow.domain.OrderItemAsserts.*;
...
class OrderItemResourceIT {
    ...
    private static final SizeType DEFAULT_SIZE_TYPE = SizeType.DEFAULT;
    private static final SizeType UPDATED_SIZE_TYPE = SizeType.CUSTOM;

    private static final Double DEFAULT_CUSTOM_LENGTH = 0D;
    private static final Double UPDATED_CUSTOM_LENGTH = 1D;

    private static final Double DEFAULT_CUSTOM_WIDTH = 0D;
    private static final Double UPDATED_CUSTOM_WIDTH = 1D;
    ...
    public static OrderItem createEntity() {
        return new OrderItem()
            ...
            .customLength(DEFAULT_CUSTOM_LENGTH)
    ...
    public static OrderItem createUpdatedEntity() {
        return new OrderItem()
            ...
            .sizeType(UPDATED_SIZE_TYPE)
            .customLength(UPDATED_CUSTOM_LENGTH)
            .customWidth(UPDATED_CUSTOM_WIDTH)
            .price(UPDATED_PRICE);
    }
    ...
    @Test
    @Transactional
    void checkSizeTypeIsRequired() throws Exception {
        long databaseSizeBeforeTest = getRepositoryCount();
        // set the field null
        orderItem.setSizeType(null);
    ...
    void getAllOrderItems() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.[*].sizeType").value(hasItem(DEFAULT_SIZE_TYPE.toString())))
            .andExpect(jsonPath("$.[*].customLength").value(hasItem(DEFAULT_CUSTOM_LENGTH)))
            .andExpect(jsonPath("$.[*].customWidth").value(hasItem(DEFAULT_CUSTOM_WIDTH)))
    ...
    void getOrderItem() throws Exception {
        ...
        restOrderItemMockMvc
            ...
            .andExpect(jsonPath("$.sizeType").value(DEFAULT_SIZE_TYPE.toString()))
            .andExpect(jsonPath("$.customLength").value(DEFAULT_CUSTOM_LENGTH))
            .andExpect(jsonPath("$.customWidth").value(DEFAULT_CUSTOM_WIDTH))
    ...
    void partialUpdateOrderItemWithPatch() throws Exception {
        ...
        partialUpdatedOrderItem.quantity(UPDATED_QUANTITY).sizeType(UPDATED_SIZE_TYPE).customWidth(UPDATED_CUSTOM_WIDTH);
