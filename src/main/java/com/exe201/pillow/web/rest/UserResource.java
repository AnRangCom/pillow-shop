...
import com.exe201.pillow.config.Constants;
import com.exe201.pillow.domain.User;
import com.exe201.pillow.repository.UserRepository;
import com.exe201.pillow.security.AuthoritiesConstants;
import com.exe201.pillow.service.MailService;
import com.exe201.pillow.service.UserService;
import com.exe201.pillow.service.dto.AdminUserDTO;
import com.exe201.pillow.web.rest.errors.BadRequestAlertException;
import com.exe201.pillow.web.rest.errors.EmailAlreadyUsedException;
import com.exe201.pillow.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.exe201.pillow.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
